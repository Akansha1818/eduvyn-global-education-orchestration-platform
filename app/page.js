...
const EduvynHomepage = () => {
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <h1 className="text-5xl lg:text-6xl font-bold text-gray-900 mb-6 leading-tight">
                Transform Your
                <span
                  className="bg-gradient-to-r from-indigo-900 to-sky-400
 ...
 text-white px-8 py-4 rounded-full font-semibold text-lg hover:shadow-xl transform hover:scale-105 transition-all flex items-center justify-center group"
                >
                  Start Your Journey
      ...
      <section
        className="py-16 bg-gradient-to-r from-indigo-900 to-sky-400
...
"
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
              Comprehensive
              <span className="bg-gradient-to-r from-indigo-900 to-sky-400 bg-clip-text text-transparent">
                {" "}
                Study Abroad{" "}
              </span>
              Services
 ...
 bg-clip-text text-transparent"
      ...
      <section
        className="py-20 bg-gradient-to-r from-indigo-900 to-sky-400
